...
connect = mysql.connector.connect(host = 'localhost', user = 'root', passwd = 'bobby2002', database = 'INVOICES')
...
def invoice_display(no): #Displaying invoice
    ...
    print('DELHIVERY EXPRESS CORPORATION, ANDHRA PRADESH\n')
...
print('WELCOME!')
print('DELIVERY EXPRESS CORPORATION')
